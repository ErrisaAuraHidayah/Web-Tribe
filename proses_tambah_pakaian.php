<?php
    if($_POST){
        ...
        if(empty($Nama_pakaian)){
            ...
            //akhir upload gambar
            $insert=mysqli_query($conn, "insert into pakaian (id_pakaian, nama_pakaian, deskripsi_pakaian, harga, gambar_pakaian) value ('".$id_pakaian."','".$Nama_pakaian."','".$Deskripsi_pakaian."','".$Harga."','".$Nama."')") or die(mysqli_error($conn));
